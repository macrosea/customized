...
# Exit if rslsync user home directory doesn't exist, is "{username}" in this script.
if [ ! -d "/home/${DAEMON_USER}" ]; then
    echo "User /home/${DAEMON_USER} does not exist. Aborting"
    exit 0
fi

if [ ! -f /media/hdd-ST380011A-EXT/external.flag-file-no-move ]; then
